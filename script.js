...
(function () {
  ...
  const I18N = {
    es: {
      ...
      "plans.b.flag": "Ideal para empezar",
      "plans.b.tag": "El primer paso para proteger su inversión.",
      "plans.b.hl": "Su rótulo vuelve a lucir como el primer día.",
      "plans.b.i1": "Limpieza profesional profunda que devuelve el brillo",
      "plans.b.i2": "Inspección general de arriba a abajo",
      "plans.b.i3": "Remoción de contaminantes que deterioran el rótulo",
      "plans.b.i4": "Revisión estructural de seguridad",
      "plans.b.i5": "Informe detallado con fotos del estado",
      "plans.b.cta": "Elegir Básico",
      "plans.p.flag": "Más popular",
      "plans.p.tag": "El equilibrio perfecto entre cuidado y tranquilidad.",
      "plans.p.hl": "Su rótulo siempre limpio y siempre encendido.",
      "plans.p.i0": "Todo lo del plan Básico, y además:",
      "plans.p.i1": "Revisión eléctrica completa",
      "plans.p.i2": "Diagnóstico de iluminación LED",
      "plans.p.i3": "Ajustes menores incluidos sin costo",
      "plans.p.i4": "Atención prioritaria",
      "plans.p.i5": "Descuentos exclusivos en reparaciones",
      "plans.p.cta": "Elegir Premium",
      "plans.g.flag": "Máxima protección",
      "plans.g.tag": "Su rótulo blindado los 365 días del año.",
      "plans.g.hl": "Cero preocupaciones: nosotros vigilamos por usted.",
      "plans.g.i0": "Todo lo del plan Premium, y además:",
      "plans.g.i1": "Respuesta de emergencia garantizada en <24h",
      "plans.g.i2": "Prioridad máxima de servicio",
      "plans.g.i3": "Visitas preventivas programadas",
      "plans.g.i4": "Cobertura para múltiples rótulos y locales",
      "plans.g.i5": "Descuentos especiales en piezas y componentes",
      "plans.g.cta": "Elegir Gold",
      "plans.foot": "Todos los planes incluyen técnicos certificados, equipo profesional y la garantía SignCare. ¿No sabe cuál elegir? Le ayudamos sin compromiso.",
...
• Teléfono: ${d.phone}${d.msg ? "\n• Mensaje: " + d.msg : ""}`,
    ...
    en: {
      ...
      "plans.b.flag": "Great to start",
      "plans.b.tag": "The first step to protect your investment.",
      "plans.b.hl": "Your sign looks like day one again.",
      "plans.b.i1": "Deep professional cleaning that brings back the shine",
      "plans.b.i2": "Full top-to-bottom general inspection",
      "plans.b.i3": "Removal of contaminants that damage the sign",
      "plans.b.i4": "Structural safety check",
      "plans.b.i5": "Detailed report with photos of the condition",
      "plans.b.cta": "Choose Basic",
      "plans.p.flag": "Most popular",
      "plans.p.tag": "The perfect balance of care and peace of mind.",
      "plans.p.hl": "Your sign always clean and always lit.",
      "plans.p.i0": "Everything in the Basic plan, plus:",
      "plans.p.i1": "Complete electrical inspection",
      "plans.p.i2": "LED lighting diagnostics",
      "plans.p.i3": "Minor adjustments included at no cost",
      "plans.p.i4": "Priority attention",
      "plans.p.i5": "Exclusive repair discounts",
      "plans.p.cta": "Choose Premium",
      "plans.g.flag": "Maximum protection",
      "plans.g.tag": "Your sign protected 365 days a year.",
      "plans.g.hl": "Zero worries: we watch over it for you.",
      "plans.g.i0": "Everything in the Premium plan, plus:",
      "plans.g.i1": "Guaranteed emergency response in <24h",
      "plans.g.i2": "Highest service priority",
      "plans.g.i3": "Scheduled preventive visits",
      "plans.g.i4": "Coverage for multiple signs and locations",
      "plans.g.i5": "Special discounts on parts and components",
      "plans.g.cta": "Choose Gold",
      "plans.foot": "Every plan includes certified technicians, professional equipment and the SignCare guarantee. Not sure which one to choose? We will help you, no strings attached.",
